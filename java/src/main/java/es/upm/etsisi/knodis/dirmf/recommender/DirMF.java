            ...
            for (int pos = 0; pos < user.getNumberOfRatings(); pos++) {
                ...
                for (int s = 0; s < ratings.length; s++) {
                    double r_ui = user.getRatingAt(pos) == ratings[s]
                            ? Math.exp(user.getRatingAt(pos)) / (ratings.length - 1 + Math.exp(user.getRatingAt(pos)))
                            : 1 / (ratings.length - 1 + Math.exp(user.getRatingAt(pos)));
            ...
            for (int pos = 0; pos < item.getNumberOfRatings(); pos++) {
                ...
                for (int s = 0; s < ratings.length; s++) {
                    double r_ui = item.getRatingAt(pos) == ratings[s]
                            ? Math.exp(item.getRatingAt(pos)) / (ratings.length - 1 + Math.exp(item.getRatingAt(pos)))
                            : 1 / (ratings.length - 1 + Math.exp(item.getRatingAt(pos)));
